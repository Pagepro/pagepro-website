        ...
        <div id="page-content">
            ...
            <div className="p-case-study">
                ...
                <main className="l-main">
                                    ...
                                    <div className="l-sec__box gr-5 gr-12@mobile no-gutter-left no-gutter@mobile">
                                        <div className="l-sec__box__head">
                                            <h3 className="t-style-fpn-l-r-u">
                                                DESKTOP <strong className="u-paint-1">walkthrough</strong>
                                            </h3>
                                        </div>
                                    </div>
                                </div>
                    ...
                    <section className="l-sec g-spacing-top-minus-6">
                        <div className="l-row c-decors-parent">
                            <div className="c-decors-box" aria-hidden="true">
                                <span className="c-photoshop-line c-photoshop-line--top"></span>
                                <span className="c-photoshop-line c-photoshop-line--bottom"></span>
                            ...
                            <div className="l-inner">
                                <div className="row row-align-between" role="row">
                                    <div className="l-sec__box gr-5 gr-12@mobile no-gutter-left no-gutter@mobile" role="columnheader">
                                        <div className="l-sec__box__head">
                                            <h3 className="t-style-fpn-l-r-u">
                                                Step 3 <strong className="u-paint-1">HTML &amp; (S)CSS coding</strong>
                                            </h3>
                                            ...
                                            <h3 className="g-gutter-top-1">Well designed SCSS</h3>
                                            <p className="g-gutter-top-1">
                                    ...
                                    <div className="l-sec__box gr-5 pull-1 g-gutter-bottom-5 g-gutter-bottom-0@desktop-small c-decors-parent h-hide@mobile" role="columnheader">
                                        <div className="c-decors-box" aria-hidden="true">
                                            <div className="l-inner--small">
                                                <span className="c-photoshop-line c-photoshop-line--right"></span>
                                                <span className="c-photoshop-line c-photoshop-line--left"></span>
                                        ...
                                        <div className="l-sec__box__head">
                                            <h3 className="t-style-fpn-l-r-u">
                                                Step 4 <strong className="u-paint-1">Animations</strong>
                                            </h3>
                                            <p className="g-gutter-top-5 g-gutter-top-3@desktop-small">
                                            ...
                                            <h3 className="g-gutter-top-1">On Scroll Animations</h3>
                                            <p className="g-gutter-top-1">
                                            ...
                                            <h3 className="g-gutter-top-1">Typing Animations</h3>
                                            <p className="g-gutter-top-1">
                                                ...
                                                <li className="c-code-example-teasers-list__item">
                                                    <div className="c-code-example-teaser u-bg-5">
                                                        <div className="c-code-example-teaser__content">
                                                            <pre><code className="html">&lt;li class=&quot;gadgets-list__item&quot;&gt;
            ...
            &lt;/li&gt;</code></pre>
                                                        ...
                                                        <div className="c-code-example-teaser__actions">
                                                            <a className="c-cta-link c-cta-link--with-label u-paint-1-on-hover" href="#">
                                    ...
                                    <div className="l-sec__box gr-5 gr-12@mobile pull-1 pull-0@mobile no-gutter-left@mobile no-gutter-right@mobile g-gutter-top-5 g-gutter-top-4@desktop-small g-gutter-top-5@mobile c-decors-parent" role="gridcell" aria-label="css code examples">
                                        ...
                                        <div className="l-sec__box__content g-gutter-top-3@mobile">
                                            <ul className="c-code-example-teasers-list">
                                                <li className="c-code-example-teasers-list__item">
                                                    <div className="c-code-example-teaser u-bg-5">
                                                        <div className="c-code-example-teaser__content">
                                                            <figure className="o-video-wrapper">
                                                        ...
                                                        <div className="c-code-example-teaser__actions">
                                                            <span className="c-ico-label">
                                                                <span className="c-ico-label__media" aria-hidden="true">
                                                                    <span className="o-icon-wrapper o-icon-wrapper--round u-bg-2 u-paint-4">
                                                                        <span className="o-icon o-icon--video"></span>
                                                                    </span>
                                                                </span>
                                                                <span className="c-ico-label__info u-text-upper">
                                                                    Animations
                                                                </span>
                                                            </span>
                                                        </div>
                                    ...
                                    <div className="l-sec__box gr-6 gr-8@mobile gr-12@mobile-medium no-gutter-left no-gutter@mobile no-gutter@mobile-medium">
                                        ...
                                        <div className="l-sec__box__content g-gutter-top-5 g-gutter-top-3@desktop-small">
                                            <p className="g-gutter-right-8@desktop-small g-gutter-right-0@tablet">
                                                We used SASS Breakpoints to create <br className="hide show@mobile" />the tablet and mobile layouts.
                                            </p>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div className="l-row c-decors-parent">
                            ...
                            <div className="l-inner">
                                <div className="row row-align-between">
                                    ...
                                    <div className="l-sec__box gr-5 gr-12@mobile pull-1 pull-0@mobile no-gutter-left@mobile no-gutter-right@mobile g-gutter-top-5 g-gutter-top-3@desktop-small g-gutter-top-1@mobile g-gutter-bottom-5 g-gutter-bottom-3@mobile">
                                        <div className="l-sec__box__content">
                                            <p>
                                    ...
                                    <div className="l-sec__box gr-adapt gr-12@tablet no-gutter no-gutter@tablet">
                                        <div className="l-sec__box__content c-decors-parent">
                                            ...
                                            <div className="c-styleguide-teaser" aria-label="visit styleguide page">
                                                <a className="c-styleguide-teaser__inner" href="http://wroc-sharp.prvsrv.com/styleguide/" target="_blank">
                        ...
                        <div className="l-row c-decors-parent">
                            <div className="l-inner">
                                <div className="row row-align-between">
                                    ...
                                    <div className="l-sec__box gr-5 gr-12@mobile pull-1 pull-0@mobile no-gutter-left@mobile no-gutter-right@mobile g-gutter-top-5 g-gutter-top-3@desktop-small g-gutter-top-1@mobile g-gutter-bottom-5">
                                        <div className="l-sec__box__content">
                                            <p>
                                            ...
                                            <blockquote className="c-testimonial g-gutter-top-5 g-gutter-bottom-5 g-gutter-left-4 g-gutter-left-0@tablet g-gutter-right-4 g-gutter-right-0@tablet" aria-label="Testimonial">
                                                ...
                                                <footer className="c-testimonial__foot g-gutter-top-4  g-gutter-top-3@desktop-small">
                                                    ...
                                                    <div className="c-testimonial__foot__info u-text-upper">
                                                        <strong className="u-decor-bottom--alt t-style-fpn-s-r">Urszula Koper</strong>, Objectivity
                                                    </div>
                                                </footer>
                                            </blockquote>
                                        </div>
                                            ...
                                            <div className="c-website-teaser__inner row h-row-align-stretch">
                                                <div className="c-website-teaser__info gr-4 gr-12@mobile-medium no-gutter-left no-gutter@mobile-medium">
                                                    <div className="c-website-teaser__info__head g-gutter-left-4 g-gutter-left-0@tablet g-gutter-top-5 g-gutter-top-0@mobile-medium g-gutter-bottom-3@mobile-medium">
                                                        <h3 className="t-style-fpn-l-r-u">WROC#</h3>
                                                    </div>
                                                    <div className="c-website-teaser__info__actions g-gutter-left-4 g-gutter-left-0@tablet g-gutter-top-2 g-gutter-top-0@mobile-medium g-gutter-bottom-2 g-gutter-bottom-0@mobile-medium">
                                                        <a className="c-cta-link s-btn-style-3" href="http://wrocsharp.com" target="_blank" >
                                                                ...
                                                                <div className="c-devices-box c-devices-box--browser">
                                                                    <div className="c-devices-box__frame">
                                                                        <strong className="c-address">
                                                                            ...
                                                                            <span className="c-address__content u-paint-2">wrocsharp.com</span>
                                                                        </strong>
                                                                    </div>
                                                                    <figure className="c-devices-box__media o-img-wrapper">
