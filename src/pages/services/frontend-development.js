        ...
        <div id="page-content">
            ...
            <div className="p-about">
                ...
                <main className="l-main">
                                ...
                                <div className="row u-paint-2">
                                    <div className="l-sec__box gr-12 no-gutter">
                                        ...
                                        <div className="l-sec__box__content g-gutter-top-5 g-gutter-top-3@desktop-small">
                                            <ul className="c-info-boxes-list c-info-boxes-list--rwd-alt g-spacing-bottom-minus-4 g-spacing-bottom-minus-2@desktop-small">
                                                <li className="c-info-boxes-list__item c-info-boxes-list__item--expanded g-spacing-bottom-5 g-spacing-bottom-3@desktop-small g-gutter-left-1@mobile">
                                                    <div className="c-info-box g-gutter-right-3 g-gutter-right-0@mobile">
                                                        ...
                                                        <div className="c-info-box__head g-gutter-top-2 g-gutter-top-1@mobile">
                                                            <span className="t-style-fpn-s-r-u u-paint-1">Single Page Applications</span>
                                                        </div>
                                                ...
                                                <li className="c-info-boxes-list__item c-info-boxes-list__item--expanded g-spacing-bottom-5 g-spacing-bottom-3@desktop-small g-gutter-left-1@mobile">
                                                    <div className="c-info-box g-gutter-right-3 g-gutter-right-0@mobile">
                                                        ...
                                                        <div className="c-info-box__head g-gutter-top-2 g-gutter-top-1@mobile">
                                                            <span className="t-style-fpn-s-r-u u-paint-1">PWA</span>
                                                        </div>
                                                        <div className="c-info-box__content g-gutter-top-2 g-gutter-top-1@mobile">
                                                            <p>
                                                ...
                                                <li className="c-info-boxes-list__item c-info-boxes-list__item--expanded g-spacing-bottom-5 g-spacing-bottom-3@desktop-small g-gutter-left-1@mobile">
                                                    <div className="c-info-box g-gutter-right-3 g-gutter-right-0@mobile">
                                                        <div className="c-info-box__media g-gutter-left-1 no-gutter@mobile" aria-hidden="true">
                                                            <span className="o-icon-wrapper o-icon-wrapper--big o-icon-wrapper--alt u-paint-1">
                                                                <span className="o-icon o-icon--chart-wordpress"></span>
                                                            </span>
                                                        </div>
                                                        <div className="c-info-box__head g-gutter-top-2 g-gutter-top-1@mobile">
                                                            <span className="t-style-fpn-s-r-u u-paint-1">WordPress Development</span>
                                                        </div>
                                                        <div className="c-info-box__content g-gutter-top-2 g-gutter-top-1@mobile">
                                                            <p>
                                                ...
                                                <li className="c-info-boxes-list__item c-info-boxes-list__item--expanded g-spacing-bottom-5 g-spacing-bottom-3@desktop-small g-gutter-left-1@mobile">
                                                    <div className="c-info-box g-gutter-right-3 g-gutter-right-0@mobile">
                                                        ...
                                                        <div className="c-info-box__head g-gutter-top-2 g-gutter-top-1@mobile">
                                                            <span className="t-style-fpn-s-r-u u-paint-1">PSD to HTML</span>
                                                        </div>
                                                        <div className="c-info-box__content g-gutter-top-2 g-gutter-top-1@mobile">
                                                            <p>
                                            ...
                                            <div className="row row-align-center g-gutter-top-3">
                                        ...
                                        <div className="l-sec__box gr-12 g-gutter-top-5 g-gutter-top-3@desktop-small u-paint-4">
                                            <ul className="c-info-boxes-list c-info-boxes-list--alt">
                                                <li className="c-info-boxes-list__item c-info-boxes-list__item--responsive g-spacing-bottom-3@desktop-small">
                                                    <div className="c-info-box g-gutter-right-0@mobile t-center l-sec__box__content">
                                                        <div className="c-info-box__media" aria-hidden="true">
                                                ...
                                                <li className="c-info-boxes-list__item c-info-boxes-list__item--responsive g-spacing-bottom-3@desktop-small">
                                                    <div className="c-info-box g-gutter-right-0@mobile t-center l-sec__box__content">
                                                        <div className="c-info-box__media" aria-hidden="true">
                                                            <figure className="o-svg-wrapper o-svg-wrapper--default"><img src={images['frontend-code.svg']} alt="SVG logo" />
                                                            </figure>
                                                        </div>
                                                        <div className="c-info-box__head g-gutter-top-2 g-gutter-top-1@mobile">
                                                            <h4 className="t-style-fpn-s-r-u u-paint-1">SVG</h4>
                                                        </div>
                                                    </div>
                                                </li>
                                                <li className="c-info-boxes-list__item c-info-boxes-list__item--responsive g-spacing-bottom-3@desktop-small">
                                                    <div className="c-info-box g-gutter-right-0@mobile t-center l-sec__box__content">
                                                        <div className="c-info-box__media" aria-hidden="true">
                                                            <figure className="o-svg-wrapper o-svg-wrapper--default"><img src={images['sass.svg']} alt="Sass logo" />
                                                            </figure>
                                                        </div>
                                                        <div className="c-info-box__head g-gutter-top-2 g-gutter-top-1@mobile">
                                                            <h4 className="t-style-fpn-s-r-u u-paint-1">Sass</h4>
                                                        </div>
                                                    </div>
                                                </li>
                                                <li className="c-info-boxes-list__item c-info-boxes-list__item--responsive g-spacing-bottom-3@desktop-small">
                                                    <div className="c-info-box g-gutter-right-0@mobile t-center l-sec__box__content">
                                                        ...
                                                        <div className="c-info-box__head g-gutter-top-2 g-gutter-top-1@mobile">
                                                            <h4 className="t-style-fpn-s-r-u u-paint-1">StoryBook</h4>
                                                        </div>
                                                    </div>
                                                </li>
                                                <li className="c-info-boxes-list__item c-info-boxes-list__item--responsive g-spacing-bottom-3@desktop-small">
                                                    <div className="c-info-box g-gutter-right-0@mobile t-center l-sec__box__content">
                                                        ...
                                                        <div className="c-info-box__head g-gutter-top-2 g-gutter-top-1@mobile">
                                                            <h4 className="t-style-fpn-s-r-u u-paint-1">TypeScript</h4>
                                                        </div>
                                                    </div>
                                                </li>
                                            </ul>
                    ...
                    />
                    <div className="l-sec u-bg-1 u-paint-4 g-gutter-top-10 g-gutter-top-5@desktop-small g-gutter-bottom-10 g-gutter-bottom-5@desktop-small g-gutter-bottom-0@tablet">
                        <div className="l-row">
                            <div className="l-inner l-inner-no-gutters@tablet">
                                <div className="row row-align-center">
                                    <div className="l-sec__box gr-12 no-gutter">
                                        <div className="l-sec__box__head g-gutter-left-2@tablet g-gutter-left-1@mobile g-gutter-right-2@tablet g-gutter-right-1@mobile">
                                            <h2 className="t-style-fpn-l-r-u">
                                                See what <strong>our partners have to say</strong>
                                            </h2>
                                        </div>
                                        <div className="l-sec__box__content g-gutter-top-5 g-gutter-top-3@desktop-small g-gutter-top-0@tablet">
                                            <div className="c-slider-wrapper c-slider-wrapper--testimonials-alt js-testimonials-alt-slider">
                                                <div className="c-slider-wrapper__container swiper-container g-gutter-top-3@tablet" aria-label="Portfolio teasers slider">
                                                    <ol className="c-testimonials-list c-testimonials-list--alt swiper-wrapper">
                                                ...
                                                <div className="c-slider-wrapper__navigation swiper-navigation g-gutter-top-5 g-gutter-top-3@mobile g-gutter-bottom-5@tablet">
                                    ...
                                    <div className="l-sec__box gr-6 gr-12@mobile-big no-gutter@mobile-big">
                                        <div className="l-sec__box__content t-style-fpn-s-r u-line-h-m">
                                            ...
                                            <p className="g-gutter-top-1 u-text-centered">
                                                <strong className="t-style-fpn-s-s">Let's build something amazing together!</strong>
                                            </p>
                                        </div>
                                    </div>
                                </div>
