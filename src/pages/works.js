                                ...
                                <ul className="c-portfolio-teasers-list c-portfolio-teasers-list--rwd-alt js-swing-anim ps-child">
                                    ...
                                    <li className="c-portfolio-teasers-list__item ui-swing-anim">
                                        <div className="c-portfolio-teaser">
                                            <a className="c-portfolio-teaser__inner u-paint-4" href="gatedtalent.html" data-animate-in="true">
                                                <div >
                                                    <BgImage
                                                        title="bgCaseGatedtalent"
                                                        fluid={props.data.bgCaseGatedtalentThumb.childImageSharp.fluid}
                                                        className="c-portfolio-teaser__media"
                                                        height='400 px'
                                                    />
                                                </div>
                                    ...
                                    <li className="c-portfolio-teasers-list__item ui-swing-anim">
                                        <div className="c-portfolio-teaser">
                                            <a className="c-portfolio-teaser__inner u-paint-4" href="my-name-flow.html" data-animate-in="true">
                                    ...
                                    <li className="c-portfolio-teasers-list__item ui-swing-anim">
                                        <div className="c-portfolio-teaser">
                                            <a className="c-portfolio-teaser__inner u-paint-4" href="blockchain-agreements.html" data-animate-in="true">
                                                <div className="c-portfolio-teaser__media" style={{ backgroundImage: 'url(static/img/bg-case-blockchain-thumb.jpg)' }}></div>
                                                <div className="c-portfolio-teaser__main">
                                                    <h2 className="t-style-fpn-l-b-u u-text-centered@mobile">
                                    ...
                                    <li className="c-portfolio-teasers-list__item ui-swing-anim">
                                        <div className="c-portfolio-teaser">
                                            <a className="c-portfolio-teaser__inner u-paint-4" href="cryptocurrency-arbitrage.html" data-animate-in="true">
                                                <div className="c-portfolio-teaser__media" style={{ backgroundImage: 'url(static/img/bg-case-crypto-thumb.jpg)' }}></div>
                                                <div className="c-portfolio-teaser__main">
                                                    <h2 className="t-style-fpn-l-b-u u-text-centered@mobile">
                                    ...
                                    <li className="c-portfolio-teasers-list__item ui-swing-anim">
                                        <div className="c-portfolio-teaser">
                                            <a className="c-portfolio-teaser__inner u-paint-4" href="310.html" data-animate-in="true">
                                                <div className="c-portfolio-teaser__media" style={{ backgroundImage: 'url(static/img/bg-case-310-thumb.jpg)' }}></div>
                                                <div className="c-portfolio-teaser__main">
                                                    <h2 className="t-style-fpn-l-b-u u-text-centered@mobile">
