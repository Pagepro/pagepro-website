                        ...
                        <div class="l-inner">
                            <div class="row">
                                ...
                                <div class="l-sec__box g-gutter-top-5">
                                    ...
                                    <div class="g-gutter-top-1">
                                        <table border="1" cellpadding="10" cellspacing="1" class="c-table">
                                            <thead>
                                                <tr>
                                                    <th scope="col" class="c-table__cell c-table__cell--header">Our Cookies</th>
                                                    <th scope="col" class="c-table__cell c-table__cell--header">Name</th>
                                                    <th scope="col" class="c-table__cell c-table__cell--header">Purpose</th>
                                                </tr>
                                            </thead>
                                            <tbody>
                                                <tr>
                                                ...
                                                <tr>
                                                    <td class="c-table__cell">Mautic**</td>
                                                    <td class="c-table__cell">mautic_referer_idAchieve
                                                mautic_session_id<br />
                                                        mtc_id<br />
                                                        mtc_sid</td>
                                                    <td class="c-table__cell">These are third-party cookies used by Mautic that allow us to use the Mautic service. We use Mautic to support our marketing activities.</td>
                                                </tr>
                                                <tr>
                                                    <td class="c-table__cell">Tawk***</td>
                                                    <td class="c-table__cell">TawkConnectionTime<br />
                                                        __tawkuuid</td>
                                                    <td class="c-table__cell">These are third-party cookies used by Tawk that allow us to use the Tawk service. We use Tawk for real-time communication with our customers via our website.</td>
                                                </tr>
                                                <tr>
                                                    <td class="c-table__cell">Django</td>
                                                    <td class="c-table__cell">django_language</td>
                                                    <td class="c-table__cell">This is a first-party cookie used by us. This cookie stores the language of the website.</td>
                                                </tr>
                                                <tr>
                                                    <td class="c-table__cell">Clutch</td>
                                                    <td class="c-table__cell">__cfduid<br />
                                                        __hssc<br />
                                                        _ _hssrc<br />
                                                        __hstc<br />
                                                        _ga<br />
                                                        _gid<br />
                                                        hubspotutk</td>
                                                    <td class="c-table__cell">These are third-party cookies used by Clutch that allow us to use the Clutch widget on our website.</td>
                                                </tr>
                                            </tbody>
                                        </table>
                                        <div class="c-table__legend g-gutter-top-1">
                                ...
                                <div class="l-sec__box g-gutter-top-5">
                                    ...
                                    <div class="l-sec__box__content g-gutter-top-2 g-gutter-top-2@desktop-small">
                                        <ol class="c-ordered-list">
                                            <li>
                                                <p class="t-style-fpn-s-r-u">Open your browser.</p>
                                            </li>
                                            <li>
                                                <p class="t-style-fpn-s-r-u">Find where the cookies are stored.</p>
                                            ...
                                            <li>
                                                <p class="t-style-fpn-s-r-u">Manage your cookies.
